...
export default function Home() {
  ...
  // Handle errors
  const handleError = () => {
    setMessages((prevMessages) => [...prevMessages, { role: "assistant", content: "Shhhh! There seems to be an error. Please try again." }]);
    setLoading(false);
    setUserInput("");
  }
  ...
  const handleSubmit = async (e) => {
    ...
    '.....thats sussy',
    '....Good question',
    'How about you stop asking me questions and get back to work...',
    ];
    var randomNumber = Math.floor(Math.random()*textArray.length);
    

    const data = textArray[randomNumber]
      ...
      <main className={styles.main}>
        ...
        <div className={styles.center}>
          ...
          <div className={styles.footer}>
           <p>Founder/CEO {" "}<a href="/" target="_blank"> augh</a>.</p>
          </div>
        </div>
      </main>
    </>
